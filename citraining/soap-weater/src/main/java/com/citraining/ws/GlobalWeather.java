    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.citraining.ws.GlobalWeather.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.citraining.ws.GlobalWeather.class.getResource(".");
