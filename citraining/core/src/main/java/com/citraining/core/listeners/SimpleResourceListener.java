...
/**
 * A service to demonstrate how changes in the resource tree can be listened for. It registers an event handler service. The component is activated
 * immediately after the bundle is started through the immediate flag. Please note, that apart from EventHandler services, the immediate flag should
